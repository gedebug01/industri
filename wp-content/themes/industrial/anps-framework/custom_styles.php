...
function anps_custom_styles_colors() {
	$c = anps_get_custom_styles_colors(); // All data XSS safe
	?>
...
function anps_get_custom_styles_font_size() {
	$sizes = array(
		'anps_body_font_size' => esc_attr(get_option('anps_body_font_size', '14')),
		'anps_h1_font_size' => esc_attr(get_option('anps_h1_font_size', '32')),
		'anps_h2_font_size' => esc_attr(get_option('anps_h2_font_size', '28')),
		'anps_h3_font_size' => esc_attr(get_option('anps_h3_font_size', '24')),
		'anps_h4_font_size' => esc_attr(get_option('anps_h4_font_size', '21')),
		'anps_h5_font_size' => esc_attr(get_option('anps_h5_font_size', '16')),
		'anps_menu_font_size' => esc_attr(get_option('anps_menu_font_size', '13')),
		'anps_submenu_font_size' => esc_attr(get_option('anps_submenu_font_size', '12')),
		'anps_top_bar_font_size' => esc_attr(get_option('anps_top_bar_font_size', '12')),
		'anps_page_heading_h1_font_size' => esc_attr(get_option('anps_page_heading_h1_font_size', '36')),
		'anps_blog_heading_h1_font_size' => esc_attr(get_option('anps_blog_heading_h1_font_size', '36')),
		'anps_footer_font_size' => esc_attr(get_option('anps_footer_font_size', '14')),
		'anps_c_footer_font_size' => esc_attr(get_option('anps_c_footer_font_size', '14'))
	);
	return $sizes;
}
...
function anps_custom_block_editor_styles() {
	...
	.editor-styles-wrapper .editor-post-title__input { color: #<?php echo esc_attr($c['anps_page_title']); ?>; }
	.editor-styles-wrapper .edit-post-visual-editor__post-title-wrapper { background-color: #<?php echo esc_attr($c['anps_page_header_background_color']); ?>; }
	.editor-styles-wrapper h1.wp-block { font-size: <?php echo esc_attr($fs['anps_h1_font_size']); ?>px; }
	.editor-styles-wrapper h2.wp-block { font-size: <?php echo esc_attr($fs['anps_h2_font_size']); ?>px; }
	.editor-styles-wrapper h3.wp-block { font-size: <?php echo esc_attr($fs['anps_h3_font_size']); ?>px; }
	.editor-styles-wrapper h4.wp-block { font-size: <?php echo esc_attr($fs['anps_h4_font_size']); ?>px; }
	.editor-styles-wrapper h5.wp-block { font-size: <?php echo esc_attr($fs['anps_h5_font_size']); ?>px; }
	.editor-styles-wrapper h1.wp-block,
	.editor-styles-wrapper h2.wp-block,
	.editor-styles-wrapper h3.wp-block,
	.editor-styles-wrapper h4.wp-block,
	.editor-styles-wrapper h5.wp-block,
	.editor-styles-wrapper h6.wp-block { color: #<?php echo esc_attr($c['anps_headings_color']); ?>; }
	...
	.editor-styles-wrapper .wp-block-file__textlink { color: #<?php echo esc_attr($c['anps_primary_color']); ?>; }
	.editor-styles-wrapper mark:not(.has-background) {
		color: #fff !important;
		background-color: #<?php echo esc_attr($c['anps_primary_color']); ?> !important;
	}
	.editor-styles-wrapper a:hover,
	.editor-styles-wrapper .wp-block-file__textlink:hover { color: #<?php echo esc_attr($c['anps_hovers_color']); ?>; }
	<?php
	return ob_get_clean();
}
